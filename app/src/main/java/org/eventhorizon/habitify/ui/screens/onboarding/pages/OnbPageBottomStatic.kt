...
import org.eventhorizon.habitify.ui.theme.AppColor.OnbTextDarkPurple
import org.eventhorizon.habitify.ui.theme.Shapes
import org.eventhorizon.habitify.ui.theme.onbSkipNextTextStyle
import org.eventhorizon.habitify.ui.theme.onbSubtitleTextStyle
...
fun OnbPageBottomStatic(
    ...
    val colorfulSubtitleText = buildAnnotatedString {
        pushStyle(SpanStyle(color = AppColor.OnbTextDarkPurple))
        append("Мы ")
    ...
    Column(
        ...
        if (pagerState.currentPage != pagerState.pageCount-1){
            ...
            Button(
                ...
                shape = Shapes.small,
                colors = ButtonColors(
                    contentColor = OnbTextDarkPurple,
